  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Chrysanthemum", image: "https://cdn.pixabay.com/photo/2019/11/04/08/43/chrysanthemum-4599545_1280.jpg", description: "Contains pyrethrin, a natural insecticide.", cost: "$16" }
      ]
    },
    {
          ...
          <div>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className='cart'>
                ...
                <span style={{ fontSize: '16px', marginLeft: '5px' }}>{totalCartCount}</span>
              </h1>
            </a>
          </div>
        </div>
